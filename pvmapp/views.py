...
from hracapp. models import EQP, INV, XP_LVL, Character_bonus, Economy, Atributs, FightLogEntry
...
def random_mob_fight(request):
    ...
    return render(request, 'pvmapp/random_mob_arena.html', {'fight_uuid': fight_uuid})
