...
class Items(models.Model):
    ...
    img = models.ImageField(upload_to='weapons_images/', blank=True, null=True)
    ...
    def __str__(self):
        return f" ({self.item_category}) / ({self.item_type}) -- {self.name} {self.level_required}-{self.level_stop} "
