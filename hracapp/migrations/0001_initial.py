    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('suma_strength', models.IntegerField(blank=True, default=1, null=True, verbose_name='Síla')),
                ('strength_base', models.IntegerField(blank=True, default=1, null=True, verbose_name='Základní síla')),
                ('strength_plus', models.IntegerField(blank=True, default=0, null=True, verbose_name='plus k síle')),
                ('suma_dexterity', models.IntegerField(blank=True, default=1, null=True, verbose_name='Obratnost')),
                ('dexterity_base', models.IntegerField(blank=True, default=1, null=True, verbose_name='Základní obratnost')),
                ('dexterity_plus', models.IntegerField(blank=True, default=0, null=True, verbose_name='plus k obratnosti')),
                ('suma_intelligence', models.IntegerField(blank=True, default=1, null=True, verbose_name='Inteligence')),
                ('intelligence_base', models.IntegerField(blank=True, default=1, null=True, verbose_name='Základní inteligence')),
                ('intelligence_plus', models.IntegerField(blank=True, default=0, null=True, verbose_name='plus k inteligenci')),
                ('suma_charisma', models.IntegerField(blank=True, default=1, null=True, verbose_name='Charisma')),
                ('charisma_base', models.IntegerField(blank=True, default=1, null=True, verbose_name='Základní charisma')),
                ('charisma_plus', models.IntegerField(blank=True, default=0, null=True, verbose_name='plus k charismatu')),
                ('suma_vitality', models.IntegerField(blank=True, default=1, null=True, verbose_name='Vitalita')),
                ('vitality_base', models.IntegerField(blank=True, default=1, null=True, verbose_name='Základní vitalita')),
                ('vitality_plus', models.IntegerField(blank=True, default=0, null=True, verbose_name='plus k vitalitě')),
                ('suma_luck', models.IntegerField(blank=True, default=1, null=True, verbose_name='Zručnost')),
                ('luck_base', models.IntegerField(blank=True, default=1, null=True, verbose_name='Základní zručnost')),
                ('luck_plus', models.IntegerField(blank=True, default=0, null=True, verbose_name='plus k zručnosti')),
